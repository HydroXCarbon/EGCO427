    ...
    <tbody>
      <tr v-for="user_alias in filterUsers" v-bind:key="user_alias.id">
        ...
        <td class="text-left">
          ...
          <router-link to="/">
            <button class="btn btn-xs btn-danger" data-toggle="modal" data-target=".bd-example-modal-sm"
              @click="DELETE(user_alias._id)"><span class="glyphicon glyphicon-trash">Delete</span></button>
          </router-link>
        </td>
      </tr>
    </tbody>
